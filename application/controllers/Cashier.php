...
class Cashier extends CI_Controller {
    ...
    public function view(){
           ...
           $fbg = $this->reg->getFB($this->input->get_post('id'));
           $e = $this->reg->getEm($this->input->get_post('id'));
           $b = $this->reg->getB($this->input->get_post('id'));
           ...
           $data = array('title' => "View Member",
                ...
                "links" => "view","fbg"=>$fbg,
                "profileinfo"=>$profile,
                "age"=>$age,"elem"=>$elem,"hs"=>$hs,"c"=>$c,"p"=>$p,"e"=>$e,"b"=>$b );
